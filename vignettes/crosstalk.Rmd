...
If you don't want to link filters, use `link_filter=FALSE`. In the example below, only the selection is linked to the previous example. (Note 2023-03-09: Selecting an item in the widget below that is filtered out above causes plotly to throw an exception.)
