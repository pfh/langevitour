...
* Try setting the point repulsion method to <button id=showOutliers>outlier</button>. You may also need to increase the amount of point repulsion. This will look for projections in which some genes have large differential expression.
