...
* Try setting point repulsion to <button id=brain1Local>local</button>.

* Examine particular cell types in detail by <button id=brain1Examine>turning off</button> the other cell types. (<button id=brain1Reset>show all</button>)

<script>
bindButton('brain1','brain1Local', {"pointRepulsionType": "local"});

bindButton('brain1','brain1Examine', {
    "pointRepulsionType": "local",
    "labelInactive": [
...
* Try setting point repulsion to <button id=brain2UltraLocal>ultralocal</button>. Ultralocal repulsion may need some fine-tuning of settings to work nicely, such as turning down the heat.
...
bindButton('brain2','brain2UltraLocal', {
    "pointRepulsionType": "ultralocal", 
    "heat": -1,
    "labelPos": [ ],
});

bindButton('brain2', 'brain2Manual', {
    "pointRepulsionType": "none",
